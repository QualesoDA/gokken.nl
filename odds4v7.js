       ...
       function checkAllFinished(){
          ...
          if(totalSumFinished == 6){
             allGames.forEach(function(obj){
                ...
                var bestBookmaker2 = (typeof obj.sites[1].site_key === 'undefined') ? "" : obj.sites[1].site_key;
                var bestBookmaker3 = (typeof obj.sites[2].site_key === 'undefined') ? "" : obj.sites[2].site_key;
